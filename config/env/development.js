...
module.exports = {
	...
	db: 'mongodb://nerdstrap:jock9560@ds056288.mongolab.com:56288/mean-dev',
	debug: true,
	logging: {
		format: 'tiny'
	},
	...
	emailFrom: 'nerdstrap@live.com', // sender address like ABC <abc@example.com>
	mailer: {
		service: 'smtp-mail.outlook.com', // Gmail, SMTP
		auth: {
			user: 'nerdstrap@live.com',
			pass: 'Jock(5^0'
		}
	},
	secret: 'j0ck$Trap'
